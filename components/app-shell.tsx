...
function ScopedAppShell() {
  ...
  if (!isSuperAdmin && active === 'admin') setActive('radar');
  ...
  return <div className="min-h-screen">
    ...
    <main key={`${active}:${revision}`}>{active==='radar'?<ManagerRadar/>:active==='conversations'?<ConversationsWorkspace/>:active==='team'?<TeamWorkspace/>:active==='admin'&&isSuperAdmin?<UserManagement/>:<Placeholder active={active}/>}</main>
