...
function ScopedAppShell() {
  ...
  return <div className="min-h-screen">
    ...
    <main key={`${visibleActive}:${revision}`}>{visibleActive==='radar'?<ManagerRadar/>:visibleActive==='conversations'?<ConversationsWorkspace/>:visibleActive==='team'?<TeamWorkspace/>:visibleActive==='insights'?<InsightsWorkspace/>:visibleActive==='admin'&&isSuperAdmin?<UserManagement/>:null}</main>
