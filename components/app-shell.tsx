...
function ScopedAppShell() {
  ...
  const { revision } = useRooftopScope();
  return <div className="min-h-screen">
    ...
    <main key={`${active}:${revision}`}>{active==='radar'?<ManagerRadar/>:active==='conversations'?<ConversationsWorkspace/>:active==='team'?<TeamWorkspace/>:<Placeholder active={active}/>}</main>
